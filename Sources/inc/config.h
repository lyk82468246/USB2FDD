...
#define FDD_READY_TIMEOUT_MS    1000
#define FDD_WRITE_PULSE_MAX_US  100
#define FDD_WRITE_PULSES_MAX    64
#define FDD_WRITE_CLOCK_MAX     128
#define FDD_WRITE_CLOCK_PULSE_US 2
